      ...
      <div className="container mx-auto">
        <div className='flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen mb-[250px] flex'>
          ...
          <motion.div variants={fadeIn('left', 0.5)} initial='hidden' whileInView={'show'} viewport={{ once: false, amount: 0.3 }} className='flex-1'>
            ...
            <p className='mb-6'>Falo Inglês e Espanhol e minhas principais soft e hard skills desenvolvidas ao longo da minha jornada são: comunicação, trabalho em equipe, Python, Java, SQL, TypeScript, React, entre muitas outras, que você pode conferir baixando meu currículo.</p>
